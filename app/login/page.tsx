...
const LoginPage = () => {
    ...
    const onLogIn = async () => {
        try {
            setLoading(true);
            const loginRoute = String(process.env.LOGIN_ROUTE);
