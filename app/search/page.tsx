...
const SearchPage = async () => {
  ...
  return (
    <div className='md:mx-16 mx-6 mt-10'>
        <div className='mx-96'>
            <input type="text" id='search' placeholder='Aadhaar' className='h-10 w-full rounded-md text-xs font-poppins font-medium pl-2 text-sblack border-2 border-sblack border-opacity-10 hover:border-sorange outline-none' />
        </div>
